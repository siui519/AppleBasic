...
<body>
    ...
    <div class="main-row">
        <h1 class="aside-header-title">Master Supplier</h1> 
    </div>   
    <div class="main">
        <input type="text" id="myInput" placeholder="Search for names.." title="Type in a name">
        <a class="btn-add" href="Supplier_Input.php?mode=add&dataid=-1"><img src="../CSS/add-icon.png"></a>
        <table id="myTable">
            <thead>
                <tr class="header">
            ...
            <?php
                $sql = "SELECT * FROM tblmsupp Where Hapus = 0";
            ...
            <tbody id="myData">
                <tr>
                    ...
                    <td><?php print($row["KdMSupp"]);?></td>
                    <td><?php print($row["NmMSupp"]);?></td>
                    <td><?php print($row["Alamat"]);?></td>
                    <td><?php print($row["Term"]);?></td>
                    <td><?php print($row["Keterangan"]);?></td>
                    <td>
                        <a class="btn-edit" href="Supplier_Input.php?mode=edit&dataid=<?php echo $row["IdMSupp"]; ?>"><img src="../CSS/edit-icon.png"></a>
                        <a class="btn-delete"  onclick="return checkDelete()" href="Delete_Data.php?master=<?php echo "supplier"; ?>&dataid=<?php echo $row["IdMSupp"]; ?>&userid=<?php echo $_SESSION['idmuser']; ?>"><img src="../CSS/delete-icon.png"></a>
                        <a class="btn-view" href="Supplier_Input.php?mode=view&dataid=<?php echo $row["IdMSupp"]; ?>"><img src="../CSS/view-icon.png"></a>
                    </td>
                </tr>
                <?php
                    }
