...
<body>
    ...
    <div class="main-row">
        <h1 class="aside-header-title">Master Barang</h1> 
    </div>   
    <div class="main">
        <input type="text" id="myInput" placeholder="Search for names.." title="Type in a name">
        <a class="btn-add" href="Barang_Input.php?mode=add&dataid=-1"><img src="../CSS/add-icon.png"></a>
        <table id="myTable">
            <thead>
                <tr class="header">
            ...
            <?php
                $sql = "SELECT * FROM tblmbrg Where Hapus = 0";
            ...
            <tbody id="myData">
                <tr>
                    ...
                    <td>
                        <a class="btn-edit" href="Barang_Input.php?mode=edit&dataid=<?php echo $row["IdMBrg"]; ?>"><img src="../CSS/edit-icon.png"></a>
                        <a class="btn-delete" onclick="return checkDelete()" href="Delete_Data.php?master=<?php echo "barang"; ?>&dataid=<?php echo $row["IdMBrg"]; ?>&userid=<?php echo $_SESSION['idmuser']; ?>" href=""><img src="../CSS/delete-icon.png"></a>
                        <a class="btn-view" href="Barang_Input.php?mode=view&dataid=<?php echo $row["IdMBrg"]; ?>"><img src="../CSS/view-icon.png"></a>
                    </td>
                </tr>
                <?php
                    }
