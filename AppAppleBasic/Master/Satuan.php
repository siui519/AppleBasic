...
<body>
    ...
    <div class="main-row">
        <h1 class="aside-header-title" id="demo">Master Satuan</h1> 
    </div>   
    <div class="main">
        <input type="text" id="myInput" placeholder="Search for names.." title="Type in a name">
        <a class="btn-add" href="Satuan_Input.php?mode=add&dataid=-1"><img src="../CSS/add-icon.png"></a>
        <table id="myTable">
            <thead>
                <tr class="header">
            ...
            <?php
                $sql = "SELECT * FROM tblmstn Where Hapus = 0";
            ...
            <tbody id="myData">
                <tr>
                    ...
                    <td><?php print($row["KdMStn"]);?></td>
                    <td><?php print($row["NmMStn"]);?></td>
                    <td><?php print($row["Keterangan"]);?></td>
                    <td>
                        <a class="btn-edit" href="Satuan_Input.php?mode=edit&dataid=<?php echo $row["IdMStn"]; ?>"><img src="../CSS/edit-icon.png"></a>
                        <a class="btn-delete" onclick="return checkDelete()" href="Delete_Data.php?master=<?php echo "satuan"; ?>&dataid=<?php echo $row["IdMStn"]; ?>&userid=<?php echo $_SESSION['idmuser']; ?>"><img src="../CSS/delete-icon.png"></a>
                        <a class="btn-view" href="Satuan_Input.php?mode=view&dataid=<?php echo $row["IdMStn"]; ?>"><img src="../CSS/view-icon.png"></a>
                    </td>
                </tr>
                <?php
                    }
